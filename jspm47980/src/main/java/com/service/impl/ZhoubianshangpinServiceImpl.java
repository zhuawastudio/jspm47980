...
public class ZhoubianshangpinServiceImpl extends ServiceImpl<ZhoubianshangpinDao, ZhoubianshangpinEntity> implements ZhoubianshangpinService {
    ...
    @Override
    public List<Map<String, Object>> selectValue(Map<String, Object> params, Wrapper<ZhoubianshangpinEntity> wrapper) {
        return baseMapper.selectValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params, Wrapper<ZhoubianshangpinEntity> wrapper) {
        return baseMapper.selectTimeStatValue(params, wrapper);
    }
    
    @Override
    public List<Map<String, Object>> selectGroup(Map<String, Object> params, Wrapper<ZhoubianshangpinEntity> wrapper) {
