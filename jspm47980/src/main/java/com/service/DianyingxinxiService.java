...
public interface DianyingxinxiService extends IService<DianyingxinxiEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<DianyingxinxiEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<DianyingxinxiEntity> wrapper);
    
    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<DianyingxinxiEntity> wrapper);
